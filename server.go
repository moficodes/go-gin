...
import (
	"github.com/moficodes/mofigogin/plugins"
	"github.com/moficodes/mofigogin/routers"
...
func main() {
	...
	// tracer, closer := jaeger.NewTracer("mofigogin",
	// 	sampler,
	// 	reporter,
	...
	log.Info("Starting mofigogin on port " + port())
